...
function setup() {
    ...
    cnv.style("left", "0");
    cnv.style("z-index", "0");
    // FIX: prevent canvas from swallowing pointer events meant for the UI controls
...
function createControls() {
    ...
    // FIX: ensure the panel itself always receives pointer events
    ...
    // FIX: explicitly allow pointer events on the select element
    paletteSelect.style("pointer-events", "auto");
    ...
    // FIX: explicitly allow pointer events on the select element
    interactionSelect.style("pointer-events", "auto");
